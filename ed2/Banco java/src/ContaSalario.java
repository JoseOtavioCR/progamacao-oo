/**
 * Representa uma conta salário, que é um tipo específico de {@link Conta}.
 *
 * A conta salário aplica uma taxa de juros diária de 8% sobre o saldo
...
public class ContaSalario extends Conta {
    ...
    public void aplicarJurosDiarios() {
        ...
        System.out.println("Juros de Conta Salário aplicado com sucesso!");
        transacoes.add("Aplicação de juros Conta Salário: R$" + juros);
    }

    /**
     * Imprime no console o extrato da conta salário, incluindo as transações
